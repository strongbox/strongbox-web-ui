...
curl -i -sS -u admin:password -H accept:application/json -H content-type:application/json -X PUT -d '{"allowedOrigins":[ "*" ]}' http://localhost:48080/api/configuration/cors && echo "" && echo ""
